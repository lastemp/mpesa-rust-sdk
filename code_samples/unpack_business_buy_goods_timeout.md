# unpack business goods timeout data

This functionality unpacks json "business goods timeout" request data.

## get_business_buy_goods_timeout

This code sample shows how to unpack json "business goods timeout" data.

```rust
use mpesa_rust_sdk::MpesaGateway;
use mpesa_rust_sdk::models::BusinessBuyGoodsFailedData;
