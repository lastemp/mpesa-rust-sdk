# unpack business goods result data

This functionality unpacks json "business goods result" request data.

## get_business_buy_goods_result

This code sample shows how to unpack json "business goods result" data.

```rust
use mpesa_rust_sdk::MpesaGateway;
use mpesa_rust_sdk::models::BusinessBuyGoodsResultData;
